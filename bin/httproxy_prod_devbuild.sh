...
#BUILD_TAG=anshu-test-tenant-4
#BUILD_TAG=external-at
# If you want to keep the vm preserved from buildsclean
# ensure that the tag name has "external"
BUILD_TAG=external-jumphost
##
...
export env_file="/home/anshup/git/anshprat/myfiles/private_keys/jenkins_oc_rc"
